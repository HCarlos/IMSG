			...
			<table aria-describedby="tblColor_info" id="tblColor" class="table table-striped table-bordered table-hover dataTable">
				<thead>
					<tr role="row">
						...
						<th aria-label="dias_dif_enteros: activate to sort column ascending" style="width: 200px;" colspan="1" rowspan="1" aria-controls="tblColor" tabindex="4" role="columnheader" class="sorting">DIAS STS</th>
						<th aria-label="dias_dif_enteros_orden: activate to sort column ascending" style="width: 200px;" colspan="1" rowspan="1" aria-controls="tblColor" tabindex="4" role="columnheader" class="sorting">DIAS CAL.</th>
						<th aria-label="status_actual: activate to sort column ascending" style="width: 200px;" colspan="1" rowspan="1" aria-controls="tblColor" tabindex="5" role="columnheader" class="sorting">STUSTUS</th>
...
jQuery(function($) {
	...
	function fillTable(){
		...
		$.post(obj.getValue(0) + "data/", {o:70, t:30, c:nc, p:54, from:0, cantidad:0,s:''},
			function(json){
					$.each(json, function(i, item) {
						...
						tB +='';
						tB +='				<td>';
						tB +='					<a href="#" class="editCM" id="modCM0-'+item.idcontrolmaster+'-'+item.idempresa+'" >'+padl(item.idcontrolmaster,4)+'</a>';
						tB +='				</td>';
						...
						tB +='				<td>'+item.dias_dif_enteros+'</td>';
						tB +='				<td>'+item.dias_dif_enteros_orden+'</td>';
						tB +='				<td '+clr+'>'+item.status_actual+'</td>';
						tB +='				<td>';
						/*
						tB +='					<div class="visible-desktop action-buttons">';
						tB +='';
						tB +='						<a class="green editCM" href="#" id="modCM-'+item.idcontrolmaster+'-'+item.idempresa+'" >';
						tB +='							<i class="icon-pencil bigger-130"></i>';
						tB +='						</a>';
						tB +='';
						tB +='						<a class="red delCM" href="#"  id="delCM-'+item.idcontrolmaster+'" >';
						tB +='							<i class="icon-trash bigger-130"></i>';
						tB +='						</a>';
						tB +='';
						tB +='						<a class="blue ordCM" href="#"  id="ordCM-'+item.idcontrolmaster+'" >';
						tB +='							<i class="fa fa-file-text bigger-130"></i>';
						tB +='						</a>';
						tB +=' ';
						tB +='						<a class="inverse ordCME" href="#" id="ordCME-'+item.idcontrolmaster+'" >';
						tB +='							<i class="icon-comment bigger-130"></i>';
						tB +='						</a>';
						tB +=' ';
						tB +='						<a class="orange ordEnd" href="#" id="ordEnd-'+item.idcontrolmaster+'-'+item.idempresa+'" >';
						tB +='							<i class="fa fa-check-circle bigger-130"></i>';
						tB +='						</a>';
						tB +='					</div>';
						*/
						tB +='				</td>';
