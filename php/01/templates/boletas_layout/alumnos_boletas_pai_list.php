...
<div class="widget-box">
    <div class="widget-header widget-header-blue widget-header-flat">
        <i class="icon-circle green"></i> <strong id="spPAIALUBolCal00"><?= $alumno; ?></strong>: <b class="text-success"><?= $grupo; ?></b> 
        <div class="widget-toolbar no-border">

            <div class="widget-toolbar">
                <button  type="button" class="btn btn-minier btn-primary arrowed-in-right arrowed closeFormUploadPAIALU00 " >
            ...
            <div class="widget-toolbar no-border">
                <button  type="button" class="btn btn-minier btn-success " id="btnViewPAIAluCal00" >
                        Consultar
                </button>
            </div>

			<div class="widget-toolbar black">
				<select id="cmbBimPAIALuCal01" size="1" class=" lbl00">
    ...
    <div class="widget-body">
        <div class="widget-main">
            ...
            <table id="tg" class="bordered2" style="font-size: 1em !important;" border="1">
            	<thead>
            		<tr>
            			<th rowspan="2" class="th1 text-left">Materia</th>
            			<th class="text-center" colspan="3" id="cr01">&nbsp;</th>
            			<th class="text-center" colspan="3" id="cr02">&nbsp;</th>
            			<th class="text-center" colspan="3" id="cr03">&nbsp;</th>
            			<th class="text-center" colspan="3" id="cr04">&nbsp;</th>
            		</tr>
            		<!--
            		<tr>
            			<th class="text-center nobold cl1" colspan="3" id="cr11">&nbsp;</th>
            			<th class="text-center nobold cl1" colspan="3" id="cr12">&nbsp;</th>
            			<th class="text-center nobold cl1" colspan="3" id="cr13">&nbsp;</th>
            			<th class="text-center nobold cl1" colspan="3" id="cr14">&nbsp;</th>
            		</tr>
            		-->
            		<tr>
            			<th class="text-center nobold" id="dr11">&nbsp;</th>
            			<th class="text-center nobold" id="dr12">&nbsp;</th>
            			<th class="text-center nobold" id="dr13">&nbsp;</th>
            			<th class="text-center nobold" id="dr21">&nbsp;</th>
            			<th class="text-center nobold" id="dr22">&nbsp;</th>
            			<th class="text-center nobold" id="dr23">&nbsp;</th>
            			<th class="text-center nobold" id="dr31">&nbsp;</th>
            			<th class="text-center nobold" id="dr32">&nbsp;</th>
            			<th class="text-center nobold" id="dr33">&nbsp;</th>
            			<th class="text-center nobold" id="dr41">&nbsp;</th>
            			<th class="text-center nobold" id="dr42">&nbsp;</th>
...
<!--
			...
			<div class="sidebar-shortcuts-large" id="gotoPrintTable">
...
jQuery(function($) {
	...
	$(".closeFormUploadPAIALU00").on("click",function(event){
	...
	$("#btnViewPAIAluCal00").on("click",function(event){
		event.preventDefault();
		...
		Eval = parseInt($("#cmbBimPAIALuCal01").val(),0);
			...
			function(json2){
	        	...
	        	if ( json2.length > 0 ){
	               ...
	               $.each(json2, function(i, item) {
	               		...
	               		// $("#cr1"+numCriterio).html(item.descripcion_criterio);

	               		$("#dr"+numCriterio+"1").html("<small>Cal</small>");
	               		$("#dr"+numCriterio+"2").html("<small>Rng.</small>");
	...
	$("#gotoPrintTable").on("click",function(event){
		event.preventDefault();
/*
		var divToPrint=document.getElementById("tg");
		newWin= window.open("");
