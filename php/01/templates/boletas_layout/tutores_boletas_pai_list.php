    ...
    <div class="widget-header widget-header-blue widget-header-flat">
        ...
        <div class="widget-toolbar no-border">
            ...
            <div class="widget-toolbar">
                <button  type="button" class="btn btn-minier btn-primary arrowed-in-right arrowed closeFormUploadDeailt00 " >
            ...
            <div class="widget-toolbar no-border">
                <button  type="button" class="btn btn-minier btn-success " id="btnViewPAICal00" >
                        Consultar
                </button>
            </div>
