		...
		$.post(obj.getValue(0) + "data/", {o:60, t:47, c:nc, p:54, from:0, cantidad:0,s:''},
			function(json){
					$.each(json, function(i, item) {
						...
						tB +='						<a class="blue configMedExa" href="#"  id="configMedExa-'+item.idexalumno+'-'+item.nombre_exalumno+'" >';
						tB +='							<i class="fa fa-user-md bigger-150"></i>';
						tB +='						</a>';
						tB +='	';
						tB +='						<a class="yellow configEmerExa " href="#"  id="configEmerExa-'+item.idexalumno+'-'+item.nombre_exalumno+'" >';
						...
						*/
						...
						if ( parseInt(item.genero,0) == 0 ){
							tB += '			<a class="pink modGruMatProKRDX02 tooltip-info " href="#" id="idgrualu2two-'+item.idexalumno+'" data-rel="tooltip" data-placement="top" data-original-title="Ver Kardex" title="Ver Kardex" >';
