...
{  
    ...
    protected $db = "imsg_dbIMSG";
    protected $user = "imsg_usrIMSG";
    protected $pwd = "_nyrCmSF~TIQ";
    ...
    public function __construct() 
    {
        if(!self::$PDOInstance) { 
	        try {
			   ...
			   self::$PDOInstance = new PDO($dsn, $this->user, $this->pwd, $driver_options);
    ...
    /**
     * Execute query and return all rows in Object
     *
     * @param string $statement
     * @return object
     */
    public function queryFetchAllAssocOBJ($statement) {
    	return self::$PDOInstance->query($statement)->fetchAll(PDO::FETCH_OBJ);
    }
