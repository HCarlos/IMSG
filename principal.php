...
<head>
    ...
    <meta content="width=device-width, initial-scale=1.0" name="viewport">
    <meta content="IMSG - Plataforma de Gestión de Servicios de Hardware" name="description">
    <meta name="keywords" content="IMSG,Plataforma,Gestión,Canon,Samsung,Toshiba,Sony,Villahermosa,Tabasco,Mantenimiento,Preventivo,Correctivo">
